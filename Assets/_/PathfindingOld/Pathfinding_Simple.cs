...
public class Pathfinding_Simple : MonoBehaviour {
    ...
    private void Start() {
        ...
        FunctionPeriodic.Create(() => {
            ...
            for (int i = 0; i < jobCount; i++) {
                FindPathJob findPathJob = new FindPathJob { startPosition = new int2(0, 0), endPosition = new int2(19, 19), path = new NativeList<PathNode>(Allocator.TempJob) };
